...
namespace RC::File
{
    ...
    static auto utf8_to_string_type(const std::string& input) -> StringType
    {
#ifdef RC_USE_WCHAR
        return to_wstring(std::string_view{input});
#else
#if __clang__
...
#pragma clang diagnostic pop
    ...
    {
        // Generated files on disk are UTF-8 regardless of the in-process string type.
    ...
    auto LinuxFile::read_all() const -> StringType
    {
        ...
        return utf8_to_string_type(file_contents);
    }
